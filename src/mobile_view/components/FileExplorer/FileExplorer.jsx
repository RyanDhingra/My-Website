...
function FileExplorer() {
    ...
    return (
        <div className='mobile-file-explorer-page'>
            <div className='mobile-file-explorer-cont'>
            ...
            <div className={changing || fileChanging ? 'mobile-file-view-cont' : 'mobile-file-view-cont mobile-changing'} style={{ width: currFile ? '45%' : '0%', marginLeft: currFile ? '1.75%' : '0%' }}>
